...
5. [Attributes](#attributes)  
    1. [Names in lowercase](#names-in-lowercase)  
    2. [Attribute values](#attribute-values)  
    3. [alt, width and height for images](#alt-width-and-height-for-images)  
    4. [Attribute order](#attribute-order)  
    5. [Spaces and equal signs](#spaces-and-equal-signs)  
    6. [Identifiers for interactive elements](#identifiers-for-interactive-elements)  
6. [HTML Performance](#html-performance)  
    1. [Loading scripts and styles](#loading-scripts-and-styles)  
    2. [Minimization of markup](#minimization-of-markup)  
